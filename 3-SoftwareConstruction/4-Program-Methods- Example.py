...
class Tracks:
    ...
    def create_album(self): # створення альбому, у якому буде трек
    ...
    def data_change(selfself): # змінити дату релізу
        self.track_date = input("Нова дата треку")
        return self.track_date

    def termination_change(self): # змінити тривалість
        self.termination = input("Нова тривалість")
        return self.termination

    def album_change(self): # змінити назву альбому
        self.album_name = input("Нова назва альбому")
        return self.album_name

    def track_info(self): # інформація про весь трек
        return self.track_name, self.track_date, self.album_name, self.termination

    def machine_check(self): # Комп'ютер перевіряє інформацію про трек
